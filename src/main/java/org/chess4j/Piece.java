 ...
 * reflected by the fact, that implementations of this class should <b>not</b>
 * override {@link Object#hashCode()} or {@link Object#equals(Object)}.
 */
public interface Piece {

    /**
     * Returns {@code true} if the given piece is of type {@link Type#ROOK}.
     * This method returns false for null values.
     *
    ...
    /**
     * Returns {@code true} if the given piece is of type {@link Type#KNIGHT}.
     * This method returns false for null values.
     *
     * @return {@code true} if the piece is of type {@link Type#KNIGHT}.
     */
    public static boolean isKnight(Piece piece) {
        return piece != null && piece.type() == Type.KNIGHT;
    }

    /**
     * Returns {@code true} if the given piece is of type {@link Type#BISHOP}.
     * This method returns false for null values.
     *
     * @return {@code true} if the piece is of type {@link Type#BISHOP}.
     */
    public static boolean isBishop(Piece piece) {
        return piece != null && piece.type() == Type.BISHOP;
    }

    /**
     * Returns {@code true} if the given piece is of type {@link Type#QUEEN}.
     * This method returns false for null values.
     *
     * @return {@code true} if the piece is of type {@link Type#QUEEN}.
     */
    public static boolean isQueen(Piece piece) {
        return piece != null && piece.type() == Type.QUEEN;
    }

    /**
     * Returns {@code true} if the given piece is of type {@link Type#KING}.
     * This method returns false for null values.
     *
    ...
    /**
     * Returns {@code true} if the given piece is of type {@link Type#PAWN}.
     * This method returns false for null values.
     *
     ...
     * @return {@code true} if the color of the first piece does not match the
     * color of the second.
     * @throws NullPointerException if any of the given parameters is
     *                              {@code null}
     */
    ...
    /**
     * Returns the UTF-8 Unicode of the piece depending on the {@link #color()}
     * and {@link #type()} of the piece.
     */
    @Override
    String toString();

    /**
     * All types of chess piece that can be placed on a board.
     */
    enum Type {
