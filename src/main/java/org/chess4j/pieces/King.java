 ...
 * only move one tile at a time except for a rochade move. The class offers two
 * static factory methods {@link #white()} and {@link #black()} for constructing
 * a king. Once created a king is immutable and stateless. Also note that no two
 * king are equal as the class does not overwrite {@link #hashCode()} nor
 * {@link #equals(Object)}.
 */
